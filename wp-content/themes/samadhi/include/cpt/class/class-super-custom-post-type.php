	...
	public function register_post_type( $customizations = array() ) {
		...
		$this->cpt = array_merge(
			apply_filters( 'scpt_plugin_default_cpt_options', array(
				...
				'label'               => $this->plural,
				'labels'              => array(
					'name'               => _x( $this->plural, $this->type, 'samadhi' ),
					'singular_name'      => _x( $this->singular, $this->type, 'samadhi' ),
					'add_new'            => _x( 'New ' . $this->singular, $this->type, 'samadhi' ),
					'add_new_item'       => _x( 'Add New ' . $this->singular, $this->type, 'samadhi' ),
					'edit_item'          => _x( 'Edit ' . $this->singular, $this->type, 'samadhi' ),
					'new_item'           => _x( 'New ' . $this->singular, $this->type, 'samadhi' ),
					'view_item'          => _x( 'View ' . $this->singular, $this->type, 'samadhi' ),
					'search_items'       => _x( 'Search ' . $this->plural, $this->type, 'samadhi' ),
					'not_found'          => _x( 'No ' . $this->plural . ' found', $this->type, 'samadhi' ),
					'not_found_in_trash' => _x( 'No ' . $this->plural . ' found in Trash', $this->type, 'samadhi' ),
					'parent_item_colon'  => _x( 'Parent ' . $this->singular . ':', $this->type, 'samadhi' ),
					'menu_name'          => _x( $this->plural, $this->type, 'samadhi' ),
				),
